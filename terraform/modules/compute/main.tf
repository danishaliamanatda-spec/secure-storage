...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "S3_BUCKET", value = var.files_bucket_id },
      { name = "DYNAMODB_TABLE_METADATA", value = var.metadata_table_name },
      { name = "DYNAMODB_TABLE_AUDIT", value = var.audit_table_name },
      { name = "DYNAMODB_TABLE_SHARES", value = var.shares_table_name },
